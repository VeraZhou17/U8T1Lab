...
public class Runner2
{
    public static void main(String[] args)
    {
        ...
        int[][] testArrH = {{1, 2, 3}, {4, 5, 6}};
        System.out.println(FunWith2DArrays.average(testArrH));
        int[][] testArrI = {{1, 2, 3, 4}, {7, 8, 9, 10}};
        System.out.println(FunWith2DArrays.average(testArrI));
